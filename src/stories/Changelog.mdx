...
* Update modal component for adapt to the content height.
* Add property to modal component for make the body scrollable.
* Add onClose property to modal component for close when click on background.
* Add closeButton property to modal component for show or hide the close button.
* Create component FormContainer for reuse.
* Rename property from FormContainer component from `fullWidth` to `fluid`.
