...
* Update colors
* Colors documentation is updated with the final colors
* Updated Button Ghost & Outlined transparent background to white. On disabled case, background has been changed to neutral-color-50
