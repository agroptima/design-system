...
* Fix `hidelabel` and `fullWidth`props in InfiniteSelect component
...
* Update Storybook to v10.5.10 and its dependencies. Update outdated and fixed vulnerable dependencies.
...
* Add `React.ReactNode` support to Input's `suffix` prop
...
* Fix PopoverMenu background color on primary variant

## 1.2.21

* Add Dismiss button in NotificationLine
...
* Show newline in DetailItem component information text

## 1.2.17

* Add Receivables icon
* Add optional prop to PopoverMenuOption for change icon variant
...
* Fix IconButton hover when is disabled

## 1.2.13

* Disable IconButton hover in mobile

## 1.2.12

* Fix text align en CardMenu button
...
* Update Pagination component to fit pagination numbers with more than 3 ciphers

## 1.2.5

* Add title to components that used accessibilityLabels for visual tooltip text
