...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          '<h2>Usage guidelines</h2><p>Use Badges when content is mapped to multiple categories, and the user needs a way to differentiate between them such as labeling or read-only situations.</p>',
      },
    },
  },
  tags: ['autodocs'],
